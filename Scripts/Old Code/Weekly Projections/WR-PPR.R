...
espn_wrproj$espn_fpts <- espn_wrproj$espn_fpts + espn_wrproj$espn_recpts
#Remove all insginicant projections
...
fp_wrproj$fp_fpts <- fp_wrproj$fp_fpts + fp_wrproj$fp_recpts
#Remove all insginicant projections
...
##MERGE DATA##
projections <- merge(cbs_wrproj, espn_wrproj, by="name", all.x = TRUE)
#projections <- merge(projections, fftoday_wrproj, by="name", all.x = TRUE)
projections <- merge(projections, ffs_wrproj, by="name", all.x = TRUE)
...
ggplot(fantasyproj, aes(x=mean, y=rank, color=factor(Tier))) +
  ...
  labs(title = paste("Week ", week , " PPR Wide Reciever Projections", sep="")) +
  coord_cartesian(xlim =c(5,(max(fantasyproj$mean)+10))) 

ggsave(paste(getwd(),"/Figures/Historical Figures/Weekly/PPR/WR/Week ",week," Wide Reciever.jpg", sep=""), width=10, height=10)
ggsave(paste(getwd(),"/Figures/Weekly/PPR/WR/Week ",week," Wide Reciever.jpg", sep=""), width=10, height=10)

#Save file
save(fantasyproj, file = paste(getwd(),"/Data/Weekly/PPR/WR/Week ",week,"-fantasyproj.RData", sep=""))
write.csv(fantasyproj, file=paste(getwd(),"/Data/Weekly/PPR/WR/Week ",week,"-fantasyproj.csv", sep=""), row.names=FALSE)

save(projections, file = paste(getwd(),"/Data/Weekly/PPR/WR/Week ",week,"-projections.RData", sep=""))
write.csv(projections, file=paste(getwd(),"/Data/Weekly/PPR/WR/Week ",week,"-projections.csv", sep=""), row.names=FALSE)
          
save(fantasyproj, file = paste(getwd(),"/Data/Historical Projections/Weekly/PPR/WR/Week ",week,"-fantasyproj.RData", sep=""))
write.csv(fantasyproj, file=paste(getwd(),"/Data/Historical Projections/Weekly/PPR/WR/Week ",week,"-fantasyproj.csv", sep=""), row.names=FALSE)
          
save(projections, file = paste(getwd(),"/Data/Historical Projections/Weekly/PPR/WR/Week ",week,"-projections.RData", sep=""))
write.csv(projections, file=paste(getwd(),"/Data/Historical Projections/Weekly/PPR/WR/Week ",week,"-projections.csv", sep=""), row.names=FALSE)
...
#save the html file
print.xtable(htmltable_fantasyproj, type="html", file=paste(getwd(),"/Data/Weekly/PPR/WR/Week ",week," tier.html",sep=""))
print.xtable(htmltable_projections, type="html", file=paste(getwd(),"/Data/Weekly/PPR/WR/Week ",week," wrprojections.html",sep=""))

print.xtable(htmltable_fantasyproj, type="html", file=paste(getwd(),"/Data/Historical Projections/Weekly/PPR/WR/Week ",week," tier.html",sep=""))
print.xtable(htmltable_projections, type="html", file=paste(getwd(),"/Data/Historical Projections/Weekly/PPR/WR/Week ",week," wrprojections.html",sep=""))
