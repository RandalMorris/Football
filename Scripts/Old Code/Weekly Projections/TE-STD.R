...
#URLS ####
url_cbs <- paste("http://www.cbssports.com/fantasy/football/stats/weeklyprojections/TE/", week, "/avg?&print_rows=9999", sep="")
...
url_fantasy_pro_ranks <- ("http://www.fantasypros.com/nfl/rankings/te.php")
url_fantasy_pro <- ("http://www.fantasypros.com/nfl/projections/te.php")
url_numfire <- paste("http://www.numberfire.com/nfl/fantasy/fantasy-football-projections/te")
...
cbs_teproj$cbs_fpts <- (cbs_teproj$cbs_yd/10) + (cbs_teproj$cbs_td*6) + (cbs_teproj$cbs_fl*-2)
...
##MERGE DATA##
projections <- merge(cbs_teproj, espn_teproj, by="name", all.x = TRUE)
projections <- merge(projections, fftoday_teproj, by="name", all.x = TRUE)
projections <- merge(projections, ffs_teproj, by="name", all.x = TRUE)
...
ggplot(fantasyproj, aes(x=mean, y=rank, color=factor(Tier))) +
  ...
  labs(title = paste("Week ", week , " Standard Tight End Projections", sep="")) +
  coord_cartesian(xlim =c(0,(max(fantasyproj$mean)+10))) 
ggsave(paste(getwd(),"/Figures/Historical Figures/Weekly/STD/TE/Week ",week," Tight End.jpg", sep=""), width=10, height=10)
ggsave(paste(getwd(),"/Figures/Weekly/STD/TE/Week ",week," Tight End.jpg", sep=""), width=10, height=10)

#Save file
save(fantasyproj, file = paste(getwd(),"/Data/Weekly/STD/TE/Week",week,"-fantasyproj.RData", sep=""))
write.csv(fantasyproj, file=paste(getwd(),"/Data/Weekly/STD/TE/Week",week,"-fantasyproj.csv", sep=""), row.names=FALSE)

save(projections, file = paste(getwd(),"/Data/Weekly/STD/TE/Week",week,"-projections.RData", sep=""))
write.csv(projections, file=paste(getwd(),"/Data/Weekly/STD/TE/Week",week,"-projections.csv", sep=""), row.names=FALSE)
          
save(fantasyproj, file = paste(getwd(),"/Data/Historical Projections/Weekly/STD/TE/Week",week,"-fantasyproj.RData", sep=""))
write.csv(fantasyproj, file=paste(getwd(),"/Data/Historical Projections/Weekly/STD/TE/Week",week,"-fantasyproj.csv", sep=""), row.names=FALSE)
          
save(projections, file = paste(getwd(),"/Data/Historical Projections/Weekly/STD/TE/Week",week,"-projections.RData", sep=""))
write.csv(projections, file=paste(getwd(),"/Data/Historical Projections/Weekly/STD/TE/Week",week,"-projections.csv", sep=""), row.names=FALSE)
...
#save the html file
print.xtable(htmltable_fantasyproj, type="html", file=paste(getwd(),"/Data/Weekly/STD/TE/Week ",week," tier.html",sep=""))
print.xtable(htmltable_projections, type="html", file=paste(getwd(),"/Data/Weekly/STD/TE/Week ",week," teprojections.html",sep=""))

print.xtable(htmltable_fantasyproj, type="html", file=paste(getwd(),"/Data/Historical Projections/Weekly/STD/TE/Week ",week," tier.html",sep=""))
print.xtable(htmltable_projections, type="html", file=paste(getwd(),"/Data/Historical Projections/Weekly/STD/TE/Week ",week," teprojections.html",sep=""))
